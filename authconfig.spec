...
Patch1: authconfig-6.1.12-no-freeipa.patch
Patch2: authconfig-6.1.12-translations.patch
...
* Thu Feb 10 2011 Tomas Mraz <tmraz@redhat.com> - 6.1.12-4
- prevent traceback when system-config-authentication run without
  X environment (#676333)

* Fri Feb  4 2011 Tomas Mraz <tmraz@redhat.com> - 6.1.12-3
- keep cache_credentials value set manually in sssd.conf (#674844)

* Thu Jan 13 2011 Tomas Mraz <tmraz@redhat.com> - 6.1.12-2
- revert changes that are incompatible with RHEL-6
- add recent translations from Transifex
...
* Thu Sep 17 2010 Tomas Mraz <tmraz@redhat.com> - 6.1.10-1
- netgroups are now supported by sssd
- updated translations from Transifex

* Tue Sep 15 2010 Tomas Mraz <tmraz@redhat.com> - 6.1.9-1
